...
public interface BillingMapper {
    ...
    @Results(id = "billingMap", value = {
            ...
            @Result(property = "bl_work_start_date", column = "bl_work_start_date"),
            @Result(property = "bl_work_end_date", column = "bl_work_end_date"),
            ...
            @Result(property = "bl_etc", column = "bl_etc"),
    ...
    @Insert("INSERT INTO billing " +
            ...
            "VALUES " +
            "(#{billing.bl_id}, " +
            "#{billing.bl_work_start_date}, " +
            "#{billing.bl_work_end_date}, " +
            "#{billing.cl_id}, " +
            "#{billing.cst_code}, " +
            "#{billing.bl_pub_date}, " +
    ...
    @Update("UPDATE billing " +
            "SET " +
            "`bl_id` = #{billing.bl_id}, " +
            "`bl_work_start_date` = #{billing.bl_work_start_date}, " +
            "`bl_work_end_date` = #{billing.bl_work_end_date}, " +
            "`cl_id` = #{billing.cl_id}, " +
