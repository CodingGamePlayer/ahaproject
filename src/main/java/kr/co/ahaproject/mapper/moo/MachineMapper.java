...
public interface MachineMapper {
    @Insert("INSERT INTO `ahaproject`.`machine` (`m_name`, `m_equip_num`, `m_type`, `m_price`,`m_tax`,`m_date`,`m_file`,`m_etc1`,`m_etc2`,`m_etc3`)" +
    "VALUES (#{machine.m_name}, #{machine.m_equip_num}, #{machine.m_type}, #{machine.m_price}, #{machine.m_tax}, #{machine.m_date}, #{machine.m_file}, #{machine.m_etc1}, #{machine.m_etc2}, #{machine.m_etc3})")
