...
public interface MachrentMapper {
    @Insert("INSERT INTO `ahaproject`.`mach_rent` (`cst_name`,`rent_start`, `rent_end`, `m_name`,`rent_supp_value`,`rent_tax`,`rent_collect_date`,`rent_collect_value`,`rent_misu`,`rent_etc`, `rent_regit`)" +
    "VALUES (#{machRent.cst_name}, #{machRent.rent_start}, #{machRent.rent_end}, #{machRent.m_name}, #{machRent.rent_supp_value}, #{machRent.rent_tax}, #{machRent.rent_collect_date}, #{machRent.rent_collect_value}, #{machRent.rent_misu}, #{machRent.rent_etc}, #{machRent.rent_regit})")
